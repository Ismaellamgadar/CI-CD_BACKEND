...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
  ...
  public JWTAuthorizationFilter(UserService userService, JwtProperties jwtProperties, AuthorityService authorityService) {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    try {
      ...
      UserDetails userDetails = new UserDetailsImpl(userService.findById(UUID.fromString(resolveToken(authToken))), authorityService);
